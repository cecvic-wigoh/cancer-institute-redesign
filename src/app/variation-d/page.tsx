...
const pages = [
  { name: "Home", href: "/variation-d/home", description: "Landing page with hero section and key information" },
  { name: "Department", href: "/variation-d/department", description: "Department overview and services" },
  { name: "Doctor Profile", href: "/variation-d/doctor-profile", description: "Individual physician profile page" },
  { name: "Research", href: "/variation-d/research", description: "Research initiatives and publications" },
];
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-[var(--color-text-light)]">
            An energetic design with strong visual elements and engaging interactions.
            Creates a memorable, forward-thinking impression.
          </p>
        </div>
        ...
        <div className="mt-8 p-4 bg-white rounded-lg border border-[var(--color-primary)]/10">
          <p className="text-sm text-[var(--color-text-light)]">
            ...
            This is a placeholder for the Variation D navigation structure.
          </p>
        </div>
      </main>
    </div>
